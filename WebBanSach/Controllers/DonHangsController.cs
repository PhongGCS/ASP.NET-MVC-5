...
namespace WebSiteBanSach.Controllers
{
    public class DonHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaDonHang,NgayGiao,NgayDat,DaThanhToan,TinhTrangGiaoHang,MaKH")] DonHang donHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaDonHang,NgayGiao,NgayDat,DaThanhToan,TinhTrangGiaoHang,MaKH")] DonHang donHang)
        {
            if (ModelState.IsValid)
            {   
